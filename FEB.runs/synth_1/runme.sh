...
HD_PWD='C:/Users/mrigatti/Desktop/CRV/2.Firmware/FEB/FEB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FEB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FEB.tcl
